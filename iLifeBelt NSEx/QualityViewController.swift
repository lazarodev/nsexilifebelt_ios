...
//  iLifeBelt NSEx
//
//  Created by Community One on 20/02/17.
...
class QualityViewController: UIViewController {
    ...
    var pieChart: PieChartView!
       ...
       override func viewDidLoad() {
        ...
        let qualities = ["Trabajadores", "Hospitalarios", "Solidarios", "Optimistas", "Honestos"]
        let porcents = [48.0, 14.0, 13.0, 13.0, 3.0]
        
        pieChart = PieChartView(frame: self.view.bounds)
        self.view.addSubview(pieChart!)
        setChart(dataPoints: qualities, values: porcents)
